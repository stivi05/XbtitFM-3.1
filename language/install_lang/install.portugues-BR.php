...
$install_lang["succes_install3"]        = "<p>Nós esperamos que você aprecie (BTITeam) o uso deste produto e que iremos ver você novamente em nosso <a href=\"http://www.xbtitfm.com/forum/index.php\" target=\"_blank\">forum</a>.</p>";
...
$install_lang["smf_download_b"]         = "</strong>) para 777 e clique em<strong>Próxima</strong> Para continuar com a instalação xbtitFM.<br /><br /><strong>* Ambos os links serão abertos em uma nova janela / aba para evitar perder o seu lugar na instalação xbtitFM.</strong></p>";
...
$install_lang["succes_upgrade3"]        = "<p>Nós esperamos que você aprecie (BTITeam) o uso deste produto e que iremos ver você novamente em nosso <a href=\"http://www.xbtitfm.com/forum/index.php\" target=\"_blank\">fórum</a>.</p>";
$install_lang['error_mysql_database']   = 'O instalador não pôde acessar o &quot;<i>%s</i>&quot; banco de dados.  Com alguns hosts, você tem de criar o banco de dados em seu painel administrativo antes de poder usá-lo (xbtitFM) . Alguns também adicionam prefixos - como o seu nome de usuário - a sua base de dados.';
