...
<head>
    ...
    <meta name="description" content="xbtitFM_3.0">
    <meta name="author" content="xbtitFM_3.0">
  ...
  <tag:ggwebmaster />
    ...
    <!-- Bootstrap Core CSS -->
    <link href="style/xbtitFM_3.0/css/bootstrap.css" rel="stylesheet">
    <!-- Theme CSS -->
    <link href="style/xbtitFM_3.0/main.css" rel="stylesheet">
    <!-- Custom Fonts -->
...
<body>
    <script src="style/xbtitFM_3.0/js/popper.min.js"></script>
    <script src="style/xbtitFM_3.0/js/bootstrap.min.js"></script>
<if:IS_DISPLAYED_2>
    <!-- Navigation -->
...
<div id='top_margin'></div>            
 <div id='bodyarea' style="padding:4ex 4ex 4ex 4ex;">
  <script type="text/javascript">
