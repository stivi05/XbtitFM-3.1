...
<head>
  ...
  <tag:ggwebmaster />
    ...
    <!-- Bootstrap Core CSS -->
    <link href="style/Rustic_Moon_3.0/css/bootstrap.css" rel="stylesheet">
    <!-- Theme CSS -->
    <link href="style/Rustic_Moon_3.0/main.css" rel="stylesheet">
    <!-- Custom Fonts -->
...
<body>
    <script src="style/Rustic_Moon_3.0/js/popper.min.js"></script>
    <script src="style/Rustic_Moon_3.0/js/bootstrap.min.js"></script>
<if:IS_DISPLAYED_2>
    <!-- Navigation -->
