...
<title><tag:SITENAME /></title>
	<link rel="stylesheet" href="./alt_login/classic/css/rotating_login.css" type="text/css" />
...
<a href="javascript:kcdmenu.toggle('login')"><img src="./alt_login/classic/login/login_r.png" border="0" title="<tag:language.LOGIN />" /></a><a href="javascript:kcdmenu.show('login')" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<if:offline_enabled_1>
<a href="javascript:alert('<tag:offline_msg />')"><img src="./alt_login/classic/login/recover_r.png" border="0" title="<tag:language.RECOVER />"  /></a><a href="javascript:kcdmenu.show('recover')" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<else:offline_enabled_1>
<a href="javascript:kcdmenu.toggle('recover')"><img src="./alt_login/classic/login/recover_r.png" border="0" title="<tag:language.RECOVER />" /></a><a href="javascript:kcdmenu.show('recover')" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</if:offline_enabled_1>
<if:offline_enabled>
<a href="javascript:alert('<tag:offline_msg />')"><img src="./alt_login/classic/login/signup_r.png" border="0" title="<tag:language.SIGNUP />" /></a><a href="javascript:kcdmenu.show('recover')" /></a>
<else:offline_enabled>
<a href="javascript:kcdmenu.toggle('signup')"><img src="./alt_login/classic/login/signup_r.png" border="0" title="<tag:language.SIGNUP />" /></a><a href="javascript:kcdmenu.show('recover')" /></a>
</if:offline_enabled>
</div>
<div class="scroller">
