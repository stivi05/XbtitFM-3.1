<table class="lista" width="100%">
  ...
  <tr>
    ...
    <td width="80%" class="lista"><tag:userdetailarr.userdetail_username /><if:pka_enabled>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[<tag:language.PREUS_PKA /> <tag:userdetailarr.userdetail_aliases />]</if:pka_enabled><tag:userdetailarr.userdetail_send_pm /><tag:userdetailarr.userdetail_edit /><tag:userdetailarr.userdetail_delete /><if:watch_1>&nbsp;<a href="index.php?page=watch&do=on&wid=<tag:userdetailarr.watchid />"><img border="0" src="images/watch.png" title="watch"></a>&nbsp;<a href="index.php?page=watch&do=off&wid=<tag:userdetailarr.watchid />"><img border="0" src="images/unwatch.png" title="unwatch"></a></if:watch_1><if:ban_button_enabled><tag:userdetailarr.userdetail_banbutton /></if:ban_button_enabled></td>
...
<tr>
      ...
      <td class="lista"><tag:reputation />&nbsp;&nbsp;&nbsp;<tag:reputation_text />&nbsp;&nbsp;[<tag:reputation_tot />] &nbsp;&nbsp;
  ...
  <tr>
      ...
      <td class="lista"><tag:userdetailarr.age /></td>
  </tr>
  </if:birthdays_enabled>
  ...
  <tr>
    ...
    <td class="lista" style="overflow:auto; max-width: 650px; max-height: 24em; display:inline-block; display:block;"<tag:userdetailarr.avatar_colspan_4 />><tag:userdetailarr.userdetail_whois /></td>
     ...
     <tr>
     <td class="header"<tag:userdetailarr.avatar_colspan_5 /> align="center"><b><tag:language.TR_TIMED_RANK_SET /></b></td>
     </tr>
         ...
         <table width="100%" cellspacing=0 border=0>
           <tr>
             ...
             <td class="lista"  width="35%" valign="middle">
               <center><input type="submit" class="btn" value="<tag:language.UPDATE />"></center>
             </td>
           </tr>
         </table>
       </td>
     ...
     <input type="hidden" name="returnto" value="index.php?page=userdetails&amp;id=<tag:userdetailarr.id />">
     <tr>
     <td class="header"<tag:userdetailarr.avatar_colspan_9 /> align="center"><b><tag:language.DON_HIST /></b></td>
     </tr>
     <tr>
    ...
    <table width="100%" cellspacing=0 border=0>
      <tr>
        ...
        <td class="lista"  width="35%" valign="middle"><center><input type="submit" class="btn" value="<tag:language.UPDATE />"></center></td>
      </tr>
    </table>
    </td></tr>
     <tr>
  ...
  <tr>
    ...
    <td class="lista" colspan="2"><tag:userdetail_mood /></td>
  ...
  <tr>
    <td class="header"><tag:language.CLIENT_PORT /></td>
...
<if:show_notes>
  <tr>
    ...
    <td class="lista"<tag:userdetailarr.avatar_colspan_14 />>
      ...
      <table width="100%">
        <tr>
          <td class="header" align="center"><b><tag:language.UN_NOTE /></b></td>
          <td class="header" align="center"><b><tag:language.UN_ADDED_BY /></b></td>
          <td class="header" align="center" width="125px"><b><tag:language.ADDED /></b></td>
          <if:note_admin_1>
...
<table class="lista" width="100%"> 
   <tr>
    <td class="block" align="center" colspan="2"><b><tag:language.BD /></b></td>
  </tr>
    <tr>
...
<table class="lista" width="100%"> 
   <tr>
    <td class="block" align="center" colspan="2"><b><tag:language.AM /></b></td>
  </tr>
      <tr>
  <form method="post" action="index.php?page=rebooted&amp;id=<tag:userdetailarr.id />">
  <input type="hidden" name="returnto" value="index.php?page=userdetails&amp;id=<tag:userdetailarr.id />"> 
  <tr>
    <td class="lista" valign="middle"><center><input type="submit" class="btn" value="<tag:language.RB />"></center></td>
  </tr>
  </form>
  </tr>
</table>
...
<table width=100%>
  <tr>
    <td class="block" align=center colspan=3><b><tag:language.BS /></b></td>
        <tr>
...
<table width="100%" class="lista">
  ...
  <tr>
	<td class="block" align="center" colspan="<tag:userdetailarr.colspan2 />" style="text-align:center;"><b><tag:language.UPLOADED /> <tag:language.TORRENTS /></b></td></tr>
  <tr><td align="center" colspan="12"><tag:userdetailarr.pagertop /></td>
  </tr>
...
<if:watched_enabled>
	<script type="text/javascript" src="jscript/jquery-1.2.3.min.js"></script>
