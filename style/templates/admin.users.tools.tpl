...
<form name="users" method="post" action="<tag:profile.frm_action />">
	<table width="100%" border="0" class="lista">
		<tr>
			...
			<td class="lista" align="left" ><input type="text" size="40" name="username" maxlength="100" value="<tag:profile.username />"/><if:user_immunity_enabled><tag:imm /></if:user_immunity_enabled><if:simple_donor_enabled>&nbsp;Donor&nbsp;<input type="checkbox" name="donor" <tag:profile.donor /> /></if:simple_donor_enabled></td>
    ...
    <tr>
			<td align="left" class="header"><tag:language.FORUM_BANNED /></td>
