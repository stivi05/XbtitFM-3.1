...
<title><tag:SITENAME /></title>
	<link rel="stylesheet" href="./alt_login/new/single/main.css" type="text/css" />
...
<center><b><tag:language.MNU_FAQ /></b></center>
          ...
          <loop:faq2>
          <table style="border-top:1px solid gold; width:100%; font-family: Verdana;font-size:10px">
              <b><tag:faq2[].faq_group_title />
           <td><tag:faq2[].faq_text /></td></tr>
          </table>
             </td>
          </tr>
           </loop:faq2>
...
<br />
<table height="46" width="100%" align="center" cellpadding="0" cellspacing="0" border="0" >
<tr>
<td class="footbg" align="center" valign="middle"><tag:alt_copyright />&nbsp;<tag:xbtit_version /><br /><tag:to_top /></td>
</tr>
</table>
<if:anon_enabled>
