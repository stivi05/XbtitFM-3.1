...
<title><tag:SITENAME /></title>
	<link rel="stylesheet" href="./alt_login/classic/css/single_login.css" type="text/css" />
...
<div id="logo">
    <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td align="center" valign="top"><img src="alt_login/classic/login/logo.png"></td>
      </tr>
    </table>
</div>
<div align="center" id="buttons">
<a href="javascript:kcdmenu.toggle('login')"><img src="./alt_login/classic/login/login_s.png" border="0" title="<tag:language.LOGIN />" /></a><a href="javascript:kcdmenu.show('login')" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<if:offline_enabled_1>
<a href="javascript:alert('<tag:offline_msg />')"><img src="./alt_login/classic/login/recover_s.png" border="0" title="<tag:language.RECOVER />"  /></a><a href="javascript:kcdmenu.show('recover')" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<else:offline_enabled_1>
<a href="javascript:kcdmenu.toggle('recover')"><img src="./alt_login/classic/login/recover_s.png" border="0" title="<tag:language.RECOVER />" /></a><a href="javascript:kcdmenu.show('recover')" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</if:offline_enabled_1>
<if:offline_enabled>
<a href="javascript:alert('<tag:offline_msg />')"><img src="./alt_login/classic/login/signup_s.png" border="0" title="<tag:language.SIGNUP />" /></a><a href="javascript:kcdmenu.show('recover')" /></a>
<else:offline_enabled>
<a href="javascript:kcdmenu.toggle('signup')"><img src="./alt_login/classic/login/signup_s.png" border="0" title="<tag:language.SIGNUP />" /></a><a href="javascript:kcdmenu.show('recover')" /></a>
</if:offline_enabled>
</div>
<div class="scroller">
...
<form method="post" action="<tag:login.action />">
  <table align="center" border="0" cellpadding="4" cellspacing="1">
    ...
    <tr>
      <td colspan="20" align="center"><tag:language.NEED_COOKIES /><br /><br /><font id="copyright"><tag:xbtit_version /> | <tag:alt_copyright /></font></td>
    </tr>
  </table>
</form>
</div>
    ...
    <div align="center">
      ...
      <tr>
         ...
         <td align="left" class="lista"><tag:scode_question /><input type="text" id="captcha" name="scode_answer" maxlength="6" size="6" value="" /></td>
          ...
          <tr>
        <td colspan="2" align="center"><input type="submit" value="<tag:language.FRM_CONFIRM />" class="btn" /><br /><br /><font id="copyright"><tag:xbtit_version /> | <tag:alt_copyright /></font></td>
      </tr>
        </table>
      </form>
    </div>
...
<form name="utente" method="post" onsubmit="return form_control()" action="<tag:account_form_actionlink />" >
  ...
  <input type="hidden" name="inviter" value="<tag:account_IDinviter />" />
	<tr>
	  <td class="lista" colspan="2"><div style="text-align:center; padding:10px;"><tag:language.INVITATION_ONLY /><br /><font id="copyright"><tag:xbtit_version /> | <tag:alt_copyright /></font></div></td>
	</tr>
  </if:BY_INVITATION>
 ...
 <input type="text" size="40" name="user" id="user" value="" />      
    ...
    <tr>
       ...
       <td align="left">
         ...
         <if:pass_sym_set><li><tag:language.SECSUI_ACC_PWD_4 /> <font id="number"><tag:pass_min_sym /></font> <if:pass_sym_plural><tag:language.SECSUI_ACC_PWD_8A /><else:pass_sym_plural><tag:language.SECSUI_ACC_PWD_8 /></if:pass_sym_plural></li></if:pass_sym_set>
...
<form method="get" name="agreeform" onsubmit="goToURL('parent');return document.returnValue" >         
  ...
  <br /><br /><font id="copyright"><tag:xbtit_version /> | <tag:alt_copyright /></font>
<else:agreement_enabled>  
              <input type="submit" name="conferma" value="<tag:language.FRM_SIGNUP />" class="btn"><br /><br /><font id="copyright"><tag:xbtit_version /> | <tag:alt_copyright /></font>  
       </td>
    </tr>
  </table>
  </if:invitation_enabled>
