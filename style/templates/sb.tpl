<if:logged_user>
  ...
  <table class="lista" width="474" align="center">
    <tr>
      <td class="header" align="center" width="26"><tag:language.OPTION /></td>
      <td class="header" align="center" width="319"><tag:language.WHAT_ABOUT /></td>
      <td class="header" align="center" width="41"><tag:language.POINTS /></td>
      <td class="header" align="center" width="62"><tag:language.EXCHANGE /> </td>
    </tr>
      ...
      <loop:gb_enable>
        <form action="seedbonus_exchange.php?id=<tag:gb_enable[].id />" method="post">
          <tr>
            ...
            <td class="lista" style="text-align:center;"><input type="submit" name="submit" value="<tag:language.EXCHANGE />!" <tag:gb_enable[].enabled />></td>
          </tr>
        </form>
      </loop:gb_enable>
    </if:gb_enabled>
    ...
    <if:vip_enabled>
      <form action="seedbonus_exchange.php?id=vip" method="post">
        <tr>
          ...
          <td class="lista"><input onclick="return confirm('<tag:language.BONUS_VIP_CONFIRM /> <tag:language.UP_TO_VIP />?')" type="submit" name="submit" value="<tag:language.EXCHANGE />!" <tag:vip_anc />></td>
        </tr>
      </form>
    </if:vip_enabled>
    ...
    <if:inv_enabled>
      <form action="seedbonus_exchange.php?id=inv" method="post">
        <tr>
          ...
          <td class="lista"><input type="submit" name="submit" value="<tag:language.EXCHANGE />!" <tag:inv1 />></td>
        </tr>
      </form>
      <form action="seedbonus_exchange.php?id=inv3" method="post">
        <tr>
          ...
          <td class="lista"><input type="submit" name="submit" value="<tag:language.EXCHANGE />!" <tag:inv3 />></td>
        </tr>
      </form>
      <form action="seedbonus_exchange.php?id=inv5" method="post">
        <tr>
          ...
          <td class="lista"><input type="submit" name="submit" value="<tag:language.EXCHANGE />!" <tag:inv5 />></td>
        </tr>
      </form>
    </if:inv_enabled>
    ...
    <if:flsl_enabled>
      <form action="seedbonus_exchange.php?id=flslot" method="post">
        <tr>
          ...
          <td class="lista"><input type="submit" name="submit" value="<tag:language.EXCHANGE />!" <tag:fls />></td>
        </tr>
      </form>
    </if:flsl_enabled>
    ...
    <if:ct_enabled>
      <tr>
        <td class="header" align="center" colspan="5" style="font-weight:bold;"><tag:language.CHANGE_CUSTOM_TITLE /><tag:price_ct />)</td>
      </tr>
      <if:can_afford_ct>
        <tr>
        ...
        <form action="title2.php?action=changetitle" method="post">
          <tr>
            ...
            <td class="lista" style="text-align:center;"><input type="submit" name="submit" value="<tag:language.EXCHANGE />!"></td>
          </tr>
        </form>
      <else:can_afford_ct>
        <tr>
    ...
    <if:un_enabled>
      <tr>
        <td class="header" style="text-align:center;font-weight:bold;" colspan="5"><tag:language.CHANGE_USERNAME /><tag:price_name />)</td>
      </tr>
      <if:can_afford_unc>
        <tr>
        ...
        <form method="post" action="username.php?action=changename">
          <tr>
            ...
            <td class="lista" style="text-align:center"><input type="submit" value="<tag:language.EXCHANGE />!"></td>
          </tr>
        </form>
      <else:can_afford_unc>
        <tr>
    ...
    <if:gift_enabled>
      <tr>
        <td class="header" colspan="4" style="text-align:center;font-weight:bold;"><tag:language.SB_MAKE_A_GIFT /></td>
      </tr>
      <tr>
      ...
      <form action="seedbonus_exchange.php?id=sb_gift" method="post">
        <tr>
          ...
          <td class="lista"><input type="hidden" name="approval_code" value="<tag:approval_code />" /><input type="submit" value="<tag:language.EXCHANGE />!" /></td>
        </tr>
      </form>
    </if:gift_enabled>
    ...
    <if:hnr_enabled>
      <tr>
        <td class="header" colspan="4" style="text-align:center;font-weight:bold;"><tag:language.SB_DECREASE_HNR /></td>
      </tr>
      <if:hnr_found>
        <tr>
          <td class="lista" rowspan="2" style="text-align:center;font-weight:bold;">12</td>
          <td class="header" style="text-align:center;"><tag:language.SB_OLDEST_HNR /></td>
          <td class="header" style="text-align:center;"><tag:language.POINTS /></td>
          <td class="header" style="text-align:center;"><tag:language.EXCHANGE /></td>
        </tr>
        <form action="seedbonus_exchange.php?id=hnr" method="post">
          <tr>
            ...
            <td class="lista" style="text-align:center;"><input type="submit" value="<tag:language.EXCHANGE />!" <tag:hnr />></td>
          </tr>
