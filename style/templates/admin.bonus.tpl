...
<table width="66%">
  ...
  <tr>
    ...
    <td class="lista" colspan="3" style="text-align:center;"><input type="text" size="3" name="bonus" maxlength="5" value="<tag:bonus />"/></td>
  </tr>
  <if:arc_enabled>
  <tr>
  ...
  <tr>
    ...
    <td class="lista" colspan="2" style="text-align:center;"><input type="text" size="4" name="bonus_max_per_hour" maxlength="4" value="<tag:bonus_max_per_hour />" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="lista" colspan="2" style="text-align:center;"><tag:language.SB_GIFTMAX />: <input type="text" name="bonus_giftmax" value="<tag:bonus_giftmax />" size="4" maxlength="6" /></td>
  <tr>
  ...
  <tr>
    ...
    <td class="lista" style="text-align:center;"><tag:language.POINTS />: <input type="text" size="4" name="bonus_upl" maxlength="6" value="<tag:bonus_upl />"/></td>
  ...
  <tr>
    ...
    <td class="lista" colspan="2" style="text-align:center;"><input type="text" size="4" name="bonus_comm" maxlength="6" value="<tag:bonus_comm />"/></td>
  </tr>
  ...
  <tr>
    ...
    <td class="lista" colspan="2" style="text-align:center;"><input type="text" size="4" name="bonus_forpost" maxlength="6" value="<tag:bonus_forpost />"/></td>
  </tr>
  ...
  <loop:traf>
         <tr>
         <td class="lista" style="text-align:center;">GB: <input type="text" size="3" name="gb<tag:traf[].name />" maxlength="3" value="<tag:traf[].traffic />"/></td>
         <td class="lista" style="text-align:center;"><tag:language.POINTS />: <input type="text" size="4" name="pts<tag:traf[].name />" maxlength="5" value="<tag:traf[].points />"/></td>
         </tr>
  </loop:traf>
  </tr>
  <tr>
    ...
    <td class="lista"<if:timed_ranks_enabled_1> <else:timed_ranks_enabled_1>colspan="2"</if:timed_ranks_enabled_1> style="text-align:center;"><input type="text" size="4" name="price_vip" maxlength="6" value="<tag:price_vip />"/></td>
  ...
  <tr>
    ...
    <td class="lista" colspan="2" style="text-align:center;"><input type="text" size="4" name="price_ct" maxlength="6" value="<tag:price_ct />"/></td>
  </tr>
  <tr>
  ...
  <td class="lista" rowspan="4"><input type="checkbox" name="inv_enable"<if:inv_enable> checked="yes"</if:inv_enable>><tag:language.ENABLE />?</td>
    <tr>
      <td class="lista" colspan="2">1 <tag:language.SB_INVITE />:&nbsp;&nbsp;<input type="text" size="3" name="inv1" maxlength="6" value="<tag:price_inv />"/></td>
    </tr>
    <tr>
      <td class="lista" colspan="2">3 <tag:language.SB_INVITES />:&nbsp;<input type="text" size="3" name="inv3" maxlength="6" value="<tag:price_inv3 />"/></td>
    </tr>
    <tr>
      <td class="lista" colspan="2">5 <tag:language.SB_INVITES />:&nbsp;<input type="text" size="3" name="inv5" maxlength="6" value="<tag:price_inv5 />"/></td>
    </tr>
  </tr>
  </if:show_inv>
  <if:show_hnr>
  <tr>
    ...
    <td class="lista" colspan="2" style="text-align:center;"><input type="text" name="price_hnr" value="<tag:price_hnr />" size="4" /></td>
  </tr>
  </if:show_hnr>
  <if:show_fls>
  <tr>
