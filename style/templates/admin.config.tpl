...
<form action="<tag:frm_action />" name="config" method="post" onsubmit="return test_smtp_password()">
  <table class="lista" width="100%" align="center">
    ...
    <tr>
      <td class="header"></td>
      <td class="lista"></td>     
      <td class="header"><tag:language.MEMCACHE /></td>
      <td class="lista"><input type="checkbox" name="memcached" value="memcached"  <tag:config.memcached /><tag:allow_memcache />/></td>    
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="lista"><input type="text" name="download_ratio" value="<tag:config.download_ratio />" size="10" /></td></td>
    </tr>
    <tr>    
    ...
    <if:ipb_in_use>
      <br /><br /><table align="center"><tr><td class="header" align="center"><tag:language.IPB_AUTO_ID /></td></tr><tr><td class="lista" style="text-align:center;"><input type="text" name="ipb_autoposter" value="<tag:config.ipb_autoposter />" size="5" /></td></tr></table>
    </if:ipb_in_use>
      </td>
      <if:forum_en_enabled>
    ...
    <tr>
      ...
      <tr>
      <td class="header" align="center" colspan="4"><tag:language.ADMIN_COMMANDS /></td>
    </tr>
     <tr>
      <td class="header"><tag:language.admin_set /></td>
      <td class="lista"><input type="text" name="is_admin" value="<tag:config.is_admin />" size="15" /></td>
      <td class="header"><tag:language.mod_set /></td>
      <td class="lista"><input type="text" name="is_mod" value="<tag:config.is_mod />" size="15" /></td>
      </tr>
      <!--<if:acp_login_enabled>
      <tr>
      <td class="header" align="center" colspan="4"><tag:language.ADMIN_LOGIN /></td>
      </tr>
      <tr>
   	  <td class="header"><tag:language.ENABLE_DISABLE_LOGIN /></td>
      <td class="lista">&nbsp;&nbsp;<tag:language.ENABLE_LOGIN />&nbsp;<input type="radio" name="acp" value="true"<tag:config.acpyes /> />&nbsp;&nbsp;<tag:language.DISABLE_LOGIN />&nbsp;<input type="radio" name="acp" value="false"<tag:config.acpno /> /></td>
   	  </tr>
      <tr>
