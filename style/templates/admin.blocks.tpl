  ...
  <table class="lista" width="100%" border="1">
    ...
    <tr>
      ...
      <loop:tops>
        <table align="center" class="lista" width="100%">
          <tr>
            <td class="block" valign="top" align="center">Classic Header Menu(s)&nbsp;&nbsp;-&nbsp;&nbsp;<tag:tops[].title /></td>
          </tr>
          <tr>
            <td>
    ...
    <tr>
      ...
      <loop:dropdown>
        ...
        <br />
		    ...
		    <!--<tr>
      <td width="30%" valign="top">-->
	<if:kc_dropdown_blocks>
    <tr>
      <td colspan="3" valign="top">
      <loop:kc_dropdown>
        <table align="center" class="lista" width="100%">
          <tr>
            <td class="block" valign="top" align="center">KC Drop Down Menu &nbsp;&nbsp;&nbsp;-<tag:kc_dropdown[].title /></td>
          </tr>
          <tr>
            <td>
              &nbsp;&nbsp;<tag:language.ENABLED />&nbsp;&nbsp;<tag:kc_dropdown[].check />
              &nbsp;<tag:kc_dropdown[].combo />
              &nbsp;<tag:kc_dropdown[].pos />
              &nbsp;Min.<tag:kc_dropdown[].combo_min_view />
              &nbsp;Max.<tag:kc_dropdown[].combo_max_view />
            </td>
          </tr>
        </table>
        <br />
    ...
    <tr>
      ...
      <loop:kc_top>
        <table align="center" class="lista" width="100%">
          <tr>
            <td class="block" valign="top" align="center">KC Top Menu &nbsp;&nbsp;&nbsp;-<tag:kc_top[].title /></td>
          </tr>
          <tr>
            <td>
              &nbsp;&nbsp;<tag:language.ENABLED />&nbsp;&nbsp;<tag:kc_top[].check />
              &nbsp;<tag:kc_top[].combo />
              &nbsp;<tag:kc_top[].pos />
              &nbsp;Min.<tag:kc_top[].combo_min_view />
              &nbsp;Max.<tag:kc_top[].combo_max_view />
            </td>
          </tr>
        </table>
        <br />
    ...
    <tr>
      ...
      <loop:kc_middle>
        <table align="center" class="lista" width="100%">
          <tr>
            <td class="block" valign="top" align="center">KC Middle Menu &nbsp;&nbsp;&nbsp;-<tag:kc_middle[].title /></td>
          </tr>
          <tr>
            <td>
              &nbsp;&nbsp;<tag:language.ENABLED />&nbsp;&nbsp;<tag:kc_middle[].check />
              &nbsp;<tag:kc_middle[].combo />
              &nbsp;<tag:kc_middle[].pos />
              &nbsp;Min.<tag:kc_middle[].combo_min_view />
              &nbsp;Max.<tag:kc_middle[].combo_max_view />
            </td>
          </tr>
        </table>
        <br />
    ...
    <tr>
      ...
      <loop:kc_footer>
        <table align="center" class="lista" width="100%">
          <tr>
            <td class="block" valign="top" align="center">KC Footer Menu &nbsp;&nbsp;&nbsp;-<tag:kc_footer[].title /></td>
          </tr>
          <tr>
            <td>
              &nbsp;&nbsp;<tag:language.ENABLED />&nbsp;&nbsp;<tag:kc_footer[].check />
              &nbsp;<tag:kc_footer[].combo />
              &nbsp;<tag:kc_footer[].pos />
              &nbsp;Min.<tag:kc_footer[].combo_min_view />
              &nbsp;Max.<tag:kc_footer[].combo_max_view />
            </td>
          </tr>
        </table>
        <br />
    ...
    <tr>
      ...
      <loop:extras>
        <table align="center" class="lista" width="100%">
          <tr>
            <td class="block" valign="top" align="center">Main Menu &nbsp;&nbsp;&nbsp;-<tag:extras[].title /></td>
          </tr>
          <tr>
            <td>
    ...
    <tr>
      ...
      <loop:altlogin>
        <table align="center" class="lista" width="100%">
          <tr>
            <td class="block" valign="top" align="center">Alternate Login &nbsp;&nbsp;&nbsp;-<tag:altlogin[].title /></td>
          </tr>
          <tr>
            <td>
