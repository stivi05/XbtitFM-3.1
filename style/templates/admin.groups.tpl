...
<div style="overflow:auto; max-width:750px;"><table class="lista" width="auto" align="center">
  ...
  <tr>
    ...
    <if:nzb>
    <td class="header" align="center"><tag:language.SET_VIP /></td>
    
    <td class="header" align="center"><tag:language.GET_VIP /></td>
    </if:nzb>
    ...
    <td class="header" align="center">Chat messenger</td>
  ...
  <tr>
    ...
    <td class="lista" style="text-align:center"><tag:groups[].STYLE /></td>
    ...
    <td class="lista" align="center"><tag:groups[].chat /></td>
