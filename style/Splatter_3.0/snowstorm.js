...
var snowStorm = (function(window, document) {
  ...
  this.flakesMaxActive = 600;      // Limit amount of snow falling at once (less = lower CPU use)
  ...
  this.snowColor = '#075ca0';        // Don't eat (or use?) yellow snow.
  ...
  this.vMaxY = 30;                 // Maximum Y velocity range for snow
