...
function popcasino(url) {newwindow=window.open(url,'popcasino','height=200,width=500,resizable=yes,scrollbars=yes,status=yes');if (window.focus) newwindow.focus();}
...
function announce(url){newwindow=window.open(url,'Announcements','height=538,width=853,resizable=yes,scrollbars=yes');if(window.focus)newwindow.focus();}
...
function gallery(url) {newwindow=window.open(url,'Gallery','height=400,width=650,resizable=yes,scrollbars=yes');if (window.focus) newwindow.focus();}
var newwindow;function popban(url){newwindow=window.open(url,'popban','height=50,width=200,resizable=yes,scrollbars=yes,status=yes,top=200,left=300');if (window.focus) newwindow.focus();}
function popvideo(url){newwindow=window.open(url,'YouTube','height=400,width=800,top=200,left=300,resizable=no,scrollbars=no');if (window.focus) newwindow.focus();}