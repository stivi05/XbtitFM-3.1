...
(1, 'menu', 'r', 5, 1, 'BLOCK_MAINMENU', 'no', 3, 8, 'no', 0, 0),
(2, 'clock', 'r', 2, 0, 'BLOCK_CLOCK', 'no', 3, 8, 'no', 0, 0),
(3, 'forum', 'l', 2, 1, 'BLOCK_FORUM', 'no', 3, 8, 'no', 0, 0),
(4, 'lastmember', 'l', 1, 1, 'BLOCK_LASTMEMBER', 'no', 3, 8, 'no', 0, 0),
(5, 'trackerinfo', 'r', 20, 1, 'BLOCK_INFO', 'no', 3, 8, 'no', 0, 0),
...
(10, 'lasttorrents', 'c', 4, 0, 'BLOCK_LASTTORRENTSC', 'no', 3, 8, 'no', 0, 0),
(11, 'news', 'c', 1, 1, 'BLOCK_NEWS', 'no', 3, 8, 'no', 0, 0),
(12, 'mainmenu', 't', 1, 1, 'BLOCK_MENU', 'no', 1, 8, 'no', 0, 0),
(13, 'maintrackertoolbar', 't', 2, 1, 'BLOCK_MAINTRACKERTOOLBAR', 'no', 3, 8, 'no', 0, 0),
(14, 'mainusertoolbar', 't', 2, 1, 'BLOCK_MAINUSERTOOLBAR', 'no', 1, 8, 'no', 0, 0),
(15, 'serverload', 'c', 8, 0, 'BLOCK_SERVERLOAD', 'no', 8, 8, 'no', 0, 0),
(16, 'poller', 'l', 3, 1, 'BLOCK_POLL', 'no', 3, 8, 'no', 0, 0),
(17, 'seedwanted', 'c', 3, 1, 'BLOCK_SEEDWANTED', 'no', 3, 8, 'no', 0, 0),
(18, 'paypal', 'r', 1, 1, 'BLOCK_PAYPAL', 'no', 3, 8, 'no', 0, 0),
(19, 'ajax_shoutbox', 'c', 2, 1, 'BLOCK_SHOUTBOX', 'no', 3, 8, 'no', 0, 0),
(20, 'hit_run', 'l', 1, 0, 'BLOCK_HIT', 'no', 3, 8, 'no', 0, 0),
(21, 'request', 'c', 6, 0, 'BLOCK_REQUEST', 'no', 3, 8, 'no', 0, 0),
(22, 'lottery', 'r', 10, 0, 'BLOCK_LOTTERY', 'no', 3, 8, 'no', 0, 0),
(23, 'led', 'a', 1, 0, 'Ticker', 'no', 3, 8, 'no', 0, 0),
(24, 'dropdownmenu', 'd', 1, 1, 'BLOCK_DDMENU', 'no', 3, 8, 'no', 0, 0),
(25, 'bet', 'l', 2, 0, 'BLOCK_BET', 'no', 3, 8, 'no', 0, 0),
(26, 'radio', 'c', 3, 0, 'BLOCK_RAD', 'no', 3, 8, 'no', 0, 0),
(27, 'topup', 'l', 1, 0, 'BLOCK_TOPU', 'no', 3, 8, 'no', 0, 0),
(28, 'circleimages', 'c', 1, 0, 'BLOCK_LASTTORRENTSC', 'no', 3, 8, 'no', 0, 0),
(29, 'lrb', 'l', 0, 0, 'BLOCK_LRB', 'no', 3, 8, 'no', 0, 0),
(30, 'birthday', 'l', 0, 0, 'BLOCK_BIRTHDAY', 'no', 3, 8, 'no', 0, 0),
(31, 'links', 'b', 1, 0, 'BLOCK_LINKS', 'no', 3, 8, 'no', 0, 0),
(32, 'last', 'c', 9, 0, 'BLOCK_LAST_DOWN', 'no', 3, 8, 'no', 0, 0),
(33, 'torrentoftheweek', 'l', 0, 0, 'BLOCK_TOW', 'no', 3, 8, 'no', 0, 0),
(34, 'altmenubar', 'e', 0, 1, 'BLOCK_ALTMENUBAR', 'no', 1, 1, 'no', 0, 0),
(35, 'calendar', 'l', 1, 1, 'BLOCK_CALENDAR', 'no', 3, 8, 'no', 0, 0),
(36, 'categories', 'l', 1, 1, 'BLOCK_CAT', 'no', 3, 8, 'no', 0, 0),
(37, 'bots', 'r', 0, 0, 'BLOCK_BOTS', 'no', 7, 8, 'no', 0, 0),
(38, 'recommended', 'c', 0, 1, 'BLOCK_RECOMMENDED', 'no', 3, 8, 'no', 0, 0),
(39, 'staffchat', 'c', 1, 0, 'BLOCK_STAFFCHAT', 'no', 3, 8, 'no', 0, 0);
...
`viewcat` ENUM( 'yes', 'no' ) NOT NULL ,
`viewtorrlist` ENUM( 'yes', 'no' ) NOT NULL ,
`viewtorrdet` ENUM( 'yes', 'no' ) NOT NULL ,
`downtorr` ENUM( 'yes', 'no' ) NOT NULL ,
...
CREATE TABLE `{$db_prefix}don_historie` (
  ...
  `donate_date` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `don_ation` int(11) NOT NULL,
  `donate_date_1` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `don_ation_1` int(11) NOT NULL,
  `donate_date_2` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `don_ation_2` int(11) NOT NULL,
  `donate_date_3` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `don_ation_3` int(11) NOT NULL,
  `donate_date_4` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `don_ation_4` int(11) NOT NULL,
  `donate_date_5` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `don_ation_5` int(11) NOT NULL,
  `donate_date_6` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `don_ation_6` int(11) NOT NULL,
  `donate_date_7` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `don_ation_7` int(11) NOT NULL,
  `donate_date_8` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `don_ation_8` int(11) NOT NULL,
  `donate_date_9` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `don_ation_9` int(11) NOT NULL,
  `donate_date_10` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
...
CREATE TABLE `{$db_prefix}files` (
  ...
  `free_expire_date` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  ...
  `user_edit` enum('true','false') NOT NULL DEFAULT 'true',
...
CREATE TABLE `{$db_prefix}file_hosting` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `added` datetime default '1000-01-01 00:00:00',
  `title` varchar(255) NOT NULL default '',
...
CREATE TABLE `{$db_prefix}files_whitelisted` (
  `id` int(11) NOT NULL,
  `info_hash` varchar(40) NOT NULL DEFAULT '',
  `users` text NOT NULL,
...
CREATE TABLE `{$db_prefix}whitelisted_groups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `description` varchar(250) NOT NULL,
  `users` text NOT NULL,
...
(1, 3, 'gold.gif', 'silver.gif', 'bronze.gif', '1', '1000-01-01', 'Gold torrent description', 'Silver torrent description', 'Bronze torrent description', 'Classic torrent description', 0, 50, 75);
...
(1, 'fmhack_invitation_system', '1.2 (FM)', 'dodge', 1516712751, '', 'no'),
(2, 'fmhack_custom_title', '1.0 (FM)', 'Real_ptr', 1516712751, '', 'fmhack_bonus_system'),
(3, 'fmhack_bonus_system', '1.3 (FM)', 'Real_ptr & Petr1fied', 1516712751, '', 'fmhack_give_points_to_uploader'),
(4, 'fmhack_donation_history', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'fmhack_advanced_auto_donation_system'),
(5, 'fmhack_simple_donor_display', '1.0 (FM)', 'Lupin', 1516712751, '', 'fmhack_advanced_auto_donation_system'),
(6, 'fmhack_timed_ranks', '1.1 (FM)', 'DiemThuy', 1516712751, '', 'fmhack_advanced_auto_donation_system'),
(7, 'fmhack_advanced_auto_donation_system', '1.3 (FM)', 'DiemThuy & cooly', 1516712751, '', 'no'),
(8, 'fmhack_gold_and_silver_torrents', '1.2 (FM)', 'Losmi & Petr1fied', 1516712751, '', 'no'),
(9, 'fmhack_free_leech_with_happy_hour', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(10, 'fmhack_torrent_image_upload', '1.1 (FM)', 'Real_ptr & Petr1fied', 1516712751, '', 'fmhack_balloons_on_mouseover|fmhack_circling_last_torrents'),
(11, 'fmhack_warning_system', '1.1 (FM)', 'linux198 & Petr1fied', 1516712751, '', 'fmhack_anti_hit_and_run_system|fmhack_low_ratio_ban_system'),
(12, 'fmhack_anti_hit_and_run_system', '1.3 (FM)', 'DiemThuy & Petr1fied', 1516712751, '', 'fmhack_reputation_system'),
(13, 'fmhack_ask_for_reseed', '1.2 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(14, 'fmhack_auto_rank', '1.3 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(15, 'fmhack_report_users_and_torrents', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'fmhack_high_UL_speed_report'),
(16, 'fmhack_booted', '1.1 (FM)', 'cooly', 1516712751, '', 'no'),
(17, 'fmhack_group_colours_overall', '1.1 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(18, 'fmhack_getIMDB_in_torrent_details', '1.1 (FM)', 'cooly', 1516712751, '', 'no'),
(19, 'fmhack_staffpanel', '1.0 (FM)', 'Lupin', 1516712751, '', 'no'),
(20, 'fmhack_rules_with_groups', '1.0 (FM)', 'Losmi', 1516712751, '', 'no'),
(21, 'fmhack_show_if_seedbox_is_used', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(22, 'fmhack_shoutbox_member_and_torrent_announce', '1.1 (FM)', 'DarkLegion & Lupin', 1516712751, '', 'no'),
(23, 'fmhack_sticky_torrent', '1.0 (FM)', 'Losmi', 1516712751, '', 'no'),
(24, 'fmhack_helpdesk', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(25, 'fmhack_torrent_request_and_vote', '1.1 (FM)', 'DiemThuy & cooly', 1516712751, '', 'no'),
(26, 'fmhack_extended_torrent_description', '1.0 (FM)', 'Khez', 1516712751, '', 'no'),
(27, 'fmhack_graphic_average_bar', '1.0 (FM)', 'miskotes', 1516712751, '', 'no'),
(28, 'fmhack_uploader_size_and_comments_on_torrent_list', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(29, 'fmhack_display_new_torrents_since_last_Visit', '1.0 (FM)', 'vasyajva', 1516712751, '', 'no'),
(30, 'fmhack_lottery', '1.0 (FM)', 'JBoy (Original: Gewa)', 1516712751, '', 'no'),
(31, 'fmhack_shoutbox_banned', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(32, 'fmhack_LED_ticker', '1.0 (FM)', 'cooly (Original idea by Diemthuy)', 1516712751, '', 'no'),
(33, 'fmhack_torrent_thanks', '1.0 (FM)', 'Lupin', 1516712751, '', 'fmhack_reputation_system'),
(34, 'fmhack_downloaded_torrents', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(35, 'fmhack_advanced_torrent_search', '1.3 (FM)', 'DiemThuy & cooly', 1516712751, '', 'no'),
(36, 'fmhack_sport_betting', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(37, 'fmhack_site_offline', '1.0 (FM)', 'Lupin', 1516712751, '', 'no'),
(38, 'fmhack_shoutcast_stats_and_DJ_application', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(39, 'fmhack_message_spy', '1.1 (FM)', 'DiemThuy & Petr1fied', 1516712751, '', 'no'),
(40, 'fmhack_download_ratio_checker', '1.0 (FM)', 'Petr1fied & fatepower', 1516712751, '', 'no'),
(41, 'fmhack_signup_bonus_upload', '1.0 (FM)', 'RBert', 1516712751, '', 'no'),
(42, 'fmhack_add_new_users_in_adminCP', '1.0 (FM)', 'Lupin', 1516712751, '', 'no'),
(43, 'fmhack_torrents_limit', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(44, 'fmhack_enhanced_wait_time', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(45, 'fmhack_ban_client', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(46, 'fmhack_auto_duplicate_torrent_checker', '1.0 (FM)', 'cooly & Petr1fied', 1516712751, '', 'no'),
(47, 'fmhack_show_members_whois_record_on_userdetails', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(48, 'fmhack_ban_button', '1.0 (FM)', 'DiemThuy & Petr1fied', 1516712751, '', 'no'),
(49, 'fmhack_ratio_editor', '1.0 (FM)', 'dodge & JBoy', 1516712751, '', 'no'),
(50, 'fmhack_speed_stats_in_peers_with_filename', '1.0 (FM)', 'miskotes & Lupin', 1516712751, '', 'no'),
(51, 'fmhack_subtitles', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(52, 'fmhack_torrent_nuked_and_requested', '1.0 (FM)', 'Author: RippeR | Conversion by Laurianti', 1516712751, '', 'no'),
(53, 'fmhack_duplicate_accounts', '1.0 (FM)', 'CobraCRK', 1516712751, '', 'no'),
(54, 'fmhack_high_UL_speed_report', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(55, 'fmhack_twitter_update', '1.0 (FM)', 'mcangeli & DiemThuy', 1516712751, '', 'no'),
(56, 'fmhack_torrent_moderation', '1.2 (FM)', 'Losmi & Petr1fied', 1516712751, '', 'no'),
(57, 'fmhack_uploader_medals', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(58, 'fmhack_NFO_uploader_-_viewer', '1.1 (FM)', 'miskotes', 1516712751, '', 'no'),
(59, 'fmhack_IMG_in_SB_after_x_shouts', '1.0 (FM)', 'DiemThuy & Petr1fied', 1516712751, '', 'no'),
(60, 'fmhack_balloons_on_mouseover', '1.1 (FM)', 'DiemThuy & Petr1fied', 1516712751, '', 'no'),
(61, 'fmhack_teams', '1.1 (FM)', 'cooly & Petr1fied', 1516712751, '', 'no'),
(62, 'fmhack_circling_last_torrents', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(63, 'fmhack_xbtit_->_SMF_style_bridge', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(64, 'fmhack_private_shouts', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(65, 'fmhack_lock_comments', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(66, 'fmhack_account_parked', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(67, 'fmhack_low_ratio_ban_system', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(68, 'fmhack_automatic_album_cover_and_picture_grabber', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(69, 'fmhack_hide_online_status', '1.1 (FM)', 'DiemThuy & Petr1fied', 1516712751, '', 'no'),
(70, 'fmhack_upload_multiplier', '1.1 (FM)', 'DiemThuy & Petr1fied', 1516712751, '', 'no'),
(71, 'fmhack_torrentBar', '1.0 (FM)', 'confe', 1516712751, '', 'no'),
(72, 'fmhack_allow_and_disallow_users_to_up_and_download', '1.0 (FM)', 'linux198', 1516712751, '', 'fmhack_detect_and_blacklist_proxy'),
(73, 'fmhack_detect_and_blacklist_proxy', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(74, 'fmhack_view_edit_delete_preview_shoutBox_comments', '1.0 (FM)', 'miskotes', 1516712751, '', 'fmhack_comments_layout'),
(75, 'fmhack_comments_layout', '1.0 (FM)', 'Real_ptr', 1516712751, '', 'fmhack_reputation_system'),
(76, 'fmhack_faq_with_groups', '1.0 (FM)', 'Losmi', 1516712751, '', 'fmhack_forced_FAQ'),
(77, 'fmhack_gifts', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(78, 'fmhack_hide_language', '2.0 (FM)', 'King Cobra', 1516712751, '', 'no'),
(79, 'fmhack_hide_style', '2.0 (FM)', 'King Cobra', 1516712751, '', 'no'),
(80, 'fmhack_bbcode_enhancements', '1.0 (FM)', 'King Cobra', 1516712751, '', 'no'),
(81, 'fmhack_auto_announce', '1.0 (FM)', 'linux198', 1516712751, '', 'no'),
(82, 'fmhack_staff_control', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(83, 'fmhack_torrent_bookmark', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(84, 'fmhack_birthdays', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(85, 'fmhack_PM_banned', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(86, 'fmhack_integrated_forum_display', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(87, 'fmhack_pm_alert_in_shoutbox', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(88, 'fmhack_view_peer_details', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(89, 'fmhack_download_prefix_or_suffix', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(90, 'fmhack_uploader_rights', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(91, 'fmhack_pager_type_select', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(92, 'fmhack_user_notes', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(93, 'fmhack_avatar_signature_sync', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(94, 'fmhack_ban_cheapmail_domains', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(95, 'fmhack_uploader_control', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(96, 'fmhack_IP_to_country', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'fmhack_last_download_block'),
(97, 'fmhack_avatar_upload', '1.0 (FM)', 'JBoy', 1516712751, '', 'no'),
(98, 'fmhack_forced_FAQ', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(99, 'fmhack_registration_open_randomly', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(100, 'fmhack_forum_auto_topic', '1.1 (FM)', 'dodge & Petr1fied', 1516712751, '', 'no'),
(101, 'fmhack_offer_to_re-encode', '1.0 (FM)', 'DiemThuy & Petr1fied', 1516712751, '', 'no'),
(102, 'fmhack_shoutbox_clean', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(103, 'fmhack_SEO_panel', '3.0 (FM)', 'atmoner', 1516712751, '', 'no'),
(104, 'fmhack_staff_comment_in_torrent_details', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(105, 'fmhack_disable_user_registration_with_duplicate_IP', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(106, 'fmhack_recommended_torrents', '1.0 (FM)', 'kvetinka', 1516712751, '', 'no'),
(107, 'fmhack_user_images', '1.0 (FM)', 'DiemThuy & Petr1fied', 1516712751, '', 'no'),
(108, 'fmhack_direct_download', '1.1 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(109, 'fmhack_about_me', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(110, 'fmhack_CBT_(Coolys_Backup_Tools)', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(111, 'fmhack_multi_tracker_scrape', '1.0 (FM)', 'Bitheaven', 1516712751, '', 'no'),
(112, 'fmhack_user_watch_list', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(113, 'fmhack_partners_page', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(114, 'fmhack_similar_torrents', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(115, 'fmhack_force_ssl', '1.0 (FM)', 'cooly', 1516712751, '', 'SSL must be installed in the server.'),
(116, 'fmhack_addthis', '1.0 (FM)', 'signo', 1516712751, '', 'no'),
(117, 'fmhack_alternate_login', '1.1 (FM)', 'King Cobra & cooly', 1516712751, '', 'no'),
(118, 'fmhack_refresh_torrent_peers', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(119, 'fmhack_online_timeout', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(120, 'fmhack_search_all_sub-categories', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(121, 'fmhack_show_or_hide_porn', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(122, 'fmhack_private_profile', '1.0 (FM)', 'MrFix', 1516712751, '', 'no'),
(123, 'fmhack_anonymous_links', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(124, 'fmhack_language_in_torrent_list_and_details', '1.0 (FM)', 'MrFix', 1516712751, '', 'no'),
(125, 'fmhack_torrent_details_media_player', '1.0 (FM)', 'Djburn', 1516712751, '', 'no'),
(126, 'fmhack_signature_on_internal_forum', '1.0 (FM)', 'Lupin', 1516712751, '', 'no'),
(127, 'fmhack_user_signup_agreement', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(128, 'fmhack_total_online_time', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(129, 'fmhack_last_download_block', '1.0 (FM)', 'DrAgon64', 1516712751, '', 'no'),
(130, 'fmhack_VIP_freeleech', '1.1 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(131, 'fmhack_torrent_view_count', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(132, 'fmhack_split_torrents_by_date', '1.0 (FM)', 'hasu (George Hasu)', 1516712751, '', 'no'),
(133, 'fmhack_social_network', '1.0 (FM)', 'Diemthuy & Petr1fied', 1516712751, '', 'no'),
(134, 'fmhack_bump_torrents', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(135, 'fmhack_advanced_RSS_feed', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(136, 'fmhack_archive_torrents', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(137, 'fmhack_ads_system', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(138, 'fmhack_default_cat_browse', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(139, 'fmhack_welcome_pm', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(140, 'fmhack_logical_rank_ordering', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(141, 'fmhack_freeleech_slots', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(142, 'fmhack_torrent_of_the_week', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(143, 'fmhack_profile_torrent_sorting', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(144, 'fmhack_comment_captcha', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(145, 'fmhack_pm_notification_on_torrent_comment', '1.0 (FM)', 'Liroy (Original author:gAnDo)', 1516712751, '', 'no'),
(146, 'fmhack_no_columns_display', '1.1 (FM)', 'cooly', 1516712751, '', 'no'),
(147, 'fmhack_protected_usernames', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(148, 'fmhack_multi_delete_torrents', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(149, 'fmhack_poll_from_integrated_forum', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(150, 'fmhack_torrent_activity_colouring', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(151, 'fmhack_grab_images_from_theTVDB', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(152, 'fmhack_advanced_prune_users_and_torrents', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(153, 'fmhack_previous_usernames', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(154, 'fmhack_download_requires_introduction', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(155, 'fmhack_only_allow_specified_email_domains', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(156, 'fmhack_magnet_links', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(157, 'fmhack_block_signup_from_certain_countries', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(158, 'fmhack_permissions_for_external_torrents', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(159, 'fmhack_torrent_times', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(160, 'fmhack_gallery', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(161, 'fmhack_custom_smileys', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(162, 'fmhack_file_hosting', '1.0 (FM)', 'Diemthuy', 1516712751, '', 'no'),
(163, 'fmhack_apply_for_membership', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(164, 'fmhack_invalid_login_system', '1.1 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(165, 'fmhack_torrent_list_and_details', '1.0 (FM)', 'King Cobra', 1516712751, '', 'no'),
(166, 'fmhack_chat_spy', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(167, 'fmhack_reputation_system', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'fmhack_advanced_auto_donation_system|fmhack_anti_hit_and_run_system|fmhack_comments_layout|fmhack_torrent_thanks'),
(168, 'fmhack_disable_user_edit_and_delete_after_24_hrs', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(169, 'fmhack_torrents_categories_subscription', '1.0 (FM)', 'Lupin', 1516712751, '', 'no'),
(170, 'fmhack_user_immunity', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(171, 'fmhack_personal_notepad', '1.0 (FM)', 'kvetinka', 1516712751, '', 'no'),
(172, 'fmhack_bot_visits', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(173, 'fmhack_show_all_uploads_per_user', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no'),
(174, 'fmhack_uploader_request_form', '1.0 (FM)', 'DiemThuy', 1516726031, '', 'no'),
(175, 'fmhack_give_points_to_uploader', '1.0 (FM)', 'hasu', 1516731021, '', 'no'),
(176, 'fmhack_admincp_login', '1.0 (FM)', 'DiemThuy', 1516903619, '', 'no'),
(177, 'fmhack_group_style_system', '1.0 (FM)', 'DiemThuy', 1517402179, '', 'no'),
(178, 'fmhack_whitelist_users_and_groups', '1.0 (FM)', 'Lupin', 1516712751, '', 'no'),
(179, 'fmhack_staff_page', '1.0 (FM)', 'Petr1fied', 1516712751, '', 'no'),
(180, 'fmhack_staff_chat', '1.0 (FM)', 'cooly', 1516712751, '', 'no'),
(181, 'fmhack_referral_system', '1.0 (FM)', 'DiemThuy', 1516712751, '', 'no');
...
CREATE TABLE `{$db_prefix}invitations` (
  ...
  `time_invited` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
...
(3, 'Bengali', 'language/bangla'),
(4, 'Bulgarian', 'language/bulgarian'),
(5, 'Chinese-Simplified', 'language/chinese'),
(6, 'Czech', 'language/czech'),
(7, 'Danish', 'language/danish'),
(8, 'Dutch', 'language/dutch'),
(9, 'Finnish', 'language/finnish'),
(10, 'Francais', 'language/french'),
(11, 'French Canadian', 'language/french_canadian'),
(12, 'German', 'language/german'),
(13, 'Greek', 'language/greek'),
(14, 'Hungarian', 'language/hungarian'),
(15, 'Italiano', 'language/italian'),
(16, 'Polish', 'language/polish'),
(17, 'Portuguese-BR', 'language/portuguese-BR'),
(18, 'Portuguese-PT', 'language/portuguese-PT'),
(19, 'Romanian', 'language/romanian'),
(20, 'Russian', 'language/russian'),
(21, 'Spanish', 'language/spanish'),
(22, 'Srpsko-Hrvatski', 'language/serbocroatian'),
(23, 'Swedish', 'language/swedish'),
(24, 'Turkish', 'language/turkish'),
(25, 'Vietnamese', 'language/vietnamese');
...
CREATE TABLE `{$db_prefix}lottery_config` (
  ...
  `lot_expire_date` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
...
(0, '1000-01-01 00:00:00', '', '', '', '', '', '2'),
(1, '1000-01-01 00:00:00', '0', '0', '0', 'closed', '0', '2');
...
(3, 'hitnrun_cleaner', 'yes', 'misc', NOW(), NOW()),
(4, 'chatspy', 'yes', 'staff', NOW(), NOW()),
(5, 'exclusive_groups', 'yes', 'misc', NOW(), NOW()),
(6, 'staff','yes','misc',NOW(),NOW()),
(7, 'referral','yes','misc',NOW(),NOW());
...
(1, , 2, '1000-01-01 00:00:00', 'Welcome to xbtitFM 3.1');
...
CREATE TABLE `{$db_prefix}reputation` (
  ...
  `updown` varchar(10) collate utf8_general_ci NOT NULL,
...
CREATE TABLE `{$db_prefix}reputation_settings` (
  `id` varchar(10) collate utf8_general_ci NOT NULL default '1',
  `rep_is_online` varchar(10) collate utf8_general_ci NOT NULL default '1',
  `rep_adminpower` varchar(10) collate utf8_general_ci NOT NULL,
  `rep_minpost` varchar(10) collate utf8_general_ci NOT NULL,
  `rep_default` varchar(10) collate utf8_general_ci NOT NULL,
  `rep_userrates` varchar(10) collate utf8_general_ci NOT NULL,
  `rep_rdpower` varchar(10) collate utf8_general_ci NOT NULL,
  `rep_pcpower` varchar(10) collate utf8_general_ci NOT NULL,
  `rep_kppower` varchar(10) collate utf8_general_ci NOT NULL,
  `rep_minrep` varchar(10) collate utf8_general_ci NOT NULL,
  `rep_maxperday` varchar(10) collate utf8_general_ci NOT NULL,
  `rep_repeat` varchar(10) collate utf8_general_ci NOT NULL,
  `rep_undefined` varchar(10) collate utf8_general_ci NOT NULL,
  `best_level` varchar(40) collate utf8_general_ci NOT NULL default 'Best Level',
  `good_level` varchar(40) collate utf8_general_ci NOT NULL default 'Good Level',
  `no_level` varchar(40) collate utf8_general_ci NOT NULL default 'No Level',
  `bad_level` varchar(40) collate utf8_general_ci NOT NULL default 'Bad Level',
  `worse_level` varchar(40) collate utf8_general_ci NOT NULL default 'Worse Level',
  `rep_upload` varchar(10) collate utf8_general_ci NOT NULL default '1',
  `rep_en_sys` varchar(10) collate utf8_general_ci NOT NULL default '1',
  `rep_pr_id` varchar(10) collate utf8_general_ci NOT NULL default '20',
  `rep_dm_id` varchar(10) collate utf8_general_ci NOT NULL default '20',
  `rep_pr` varchar(10) collate utf8_general_ci NOT NULL default '1000',
  `rep_dm` varchar(10) collate utf8_general_ci NOT NULL default '-1000',
  `rep_pm_text` varchar(255) collate utf8_general_ci NOT NULL default 'text',
  `rep_dm_text` varchar(255) collate utf8_general_ci NOT NULL default 'text'
); -- TABLEOPT --

INSERT INTO `{$db_prefix}reputation_settings` (`id`, `rep_is_online`, `rep_adminpower`, `rep_minpost`, `rep_default`, `rep_userrates`, `rep_rdpower`, `rep_pcpower`, `rep_kppower`, `rep_minrep`, `rep_maxperday`, `rep_repeat`, `rep_undefined`, `best_level`, `good_level`, `no_level`, `bad_level`, `worse_level`, `rep_upload`, `rep_en_sys`, `rep_pr_id`, `rep_dm_id`, `rep_pr`, `rep_dm`, `rep_pm_text`, `rep_dm_text`) VALUES
('1', 'false', '10', '20', '0', '1', '1', '4', '2', '10', '2', '', '3', 'Top Users Reputation', 'Good Users Reputation', 'No Reputation Yet', 'Bad Users Reputation', 'Worse Users Reputation', '10', 'false', '5', '3', '1000', '-1000', 'promote text', 'demote text');
...
CREATE TABLE `{$db_prefix}requests` (
  ...
  `descr` text NOT NULL,
  `added` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `fulfilled` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `hits` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `{$db_prefix}sb_control` (
  `id` int(5) NOT NULL,
...
CREATE TABLE `{$db_prefix}serials` (
...
('invalid_login', 'disabled'),
('attempts_login', '6'),
('fmhack_invalid_login_system', 'disabled'),
('download_ratio', '2147483648'),
('memcached', 'false'),
('fmhack_torrent_list_and_details', 'disabled'),
('torrent_list', 'classic'),
('torrent_details', 'classic'),
('fmhack_chat_spy', 'disabled'),
('shouton', 'true'),
('is_mod', 'edit_torrents'),
('is_admin', 'delete_users'),
('fmhack_reputation_system', 'disabled'),
('fmhack_disable_user_edit_and_delete_after_24_hrs', 'disabled'),
('fmhack_torrents_categories_subscription', 'disabled'),
('fmhack_user_immunity', 'disabled'),
('fmhack_personal_notepad', 'disabled'),
('fmhack_bot_visits', 'disabled'),
('fmhack_show_all_uploads_per_user', 'disabled'),
('up_id', '2'),
('up_all', 'disabled'),
('acp', 'false'),
('un1', 'admin'),
...
('fmhack_uploader_request_form', 'disabled'),
('fmhack_give_points_to_uploader', 'disabled'),
('fmhack_admincp_login', 'disabled'),
('give_points', 'enabled'),
('fmhack_group_style_system', 'disabled'),
('style', 'false'),
('set_date_format', 'F d, Y,'),
('set_time_format', 'h:i:s A'),
('cl_on', 'false'),
('cl_te', 'text'),
('fmhack_whitelist_users_and_groups', 'disabled'),
('fmhack_staff_page', 'disabled'),
('fmhack_staff_chat', 'disabled'),
('fmhack_referral_system', 'disabled'),
('ref_on', 'false'),
('ref_switch', 'true'),
('ref_gb', '5'),
('ref_sb', '1000');
...
(1, 'xbtitFM 3.0', 'style/xbtitFM_3.0', 3),
(2, 'Black Neon 3.0', 'style/Black_Neon_3.0', 3),
(3, 'Cherry Splash 3.0', 'style/Cherry_Splash_3.0', 3),
(4, 'Rustic Moon 3.0', 'style/Rustic_Moon_3.0', 3),
(5, 'Splatter 3.0', 'style/Splatter_3.0', 3),
(6, 'SR-5 3.0', 'style/SR-5_3.0', 3),
(7, 'Valentine 3.0', 'style/Valentine_3.0', 3);
...
CREATE TABLE `{$db_prefix}users` (
  ...
  `invitedate` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  ...
  `timed_rank` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `warn` enum('yes','no') NOT NULL DEFAULT 'no',
  `warnreason` varchar(255) NOT NULL,
  `warnadded` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `warns` bigint(20) DEFAULT '0',
  `warnaddedby` varchar(255) NOT NULL,
  `booted` enum('yes','no') NOT NULL DEFAULT 'no',
  `whybooted` varchar(255) NOT NULL,
  `addbooted` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  ...
  `rat_warn_time` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  ...
  `secret` varchar(20) binary NOT NULL,
...
INSERT INTO `{$db_prefix}users_level` (`id`, `id_level`, `level`, `view_torrents`, `edit_torrents`, `delete_torrents`, `view_users`, `edit_users`, `delete_users`, `view_news`, `edit_news`, `delete_news`, `can_upload`, `can_download`, `view_forum`, `edit_forum`, `delete_forum`, `predef_level`, `can_be_deleted`, `admin_access`, `prefixcolor`, `suffixcolor`, `WT`, `autorank_state`, `autorank_position`, `autorank_min_upload`, `autorank_minratio`, `smf_group_mirror`, `ipb_group_mirror`, `bypass_dlcheck`, `torrents_limit`, `trusted`, `moderate_trusted`, `sel_team`, `all_teams`, `delete_comments`, `edit_comments`, `view_comments`, `delete_shout`, `edit_shout`, `view_shout`, `view_peers`, `view_history`, `view_userdetails_torrents`, `view_nfo`, `view_reencode`, `add_request`, `add_ddl`, `view_ddl`, `freeleech`, `can_hide`, `see_hidden`, `bump_torrents`, `set_multi`, `view_multi`, `view_new`, `up_new`, `down_new`, `view_arc`, `up_arc`, `down_arc`, `logical_rank_order`, `can_boot`, `down_req_intro`, `external_upload`, `external_refresh`, `reputation`, `subscription`, `immunity`, `STYLE`) VALUES
(1, 1, 'guest', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'guest', 'no', 'no', '', '', 0, 'Disabled', 0, 0, '0.00', 0, 0, 0, 0, 'no', 'no', 0, 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 1, 'no', 'no', 'no', 'no', '0', NULL, 'no', 1),
(2, 2, 'validating', 'yes', 'no', 'no', 'no', 'no', 'no', 'yes', 'no', 'no', 'no', 'no', 'yes', 'no', 'no', 'validating', 'no', 'no', '', '', 0, 'Disabled', 0, 0, '0.00', 0, 0, 0, 0, 'no', 'no', 0, 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 2, 'no', 'no', 'no', 'no', '0', NULL, 'no', 1),
(3, 3, 'Members', 'yes', 'no', 'no', 'yes', 'no', 'no', 'yes', 'no', 'no', 'no', 'yes', 'yes', 'no', 'no', 'member', 'no', 'no', '<span style=''color:#000000''>', '</span>', 0, 'Disabled', 0, 0, '0.00', 0, 0, 0, 0, 'no', 'no', 0, 'no', 'no', 'no', 'no', 'no', 'no', 'yes', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 3, 'no', 'no', 'no', 'no', '0', NULL, 'no', 1),
(4, 4, 'Uploader', 'yes', 'no', 'no', 'yes', 'no', 'no', 'yes', 'no', 'no', 'yes', 'yes', 'yes', 'no', 'no', 'uploader', 'no', 'no', '', '', 0, 'Disabled', 0, 0, '0.00', 0, 0, 0, 0, 'no', 'no', 0, 'no', 'no', 'no', 'no', 'no', 'no', 'yes', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 4, 'no', 'no', 'no', 'no', '0', NULL, 'no', 1),
(5, 5, 'V.I.P.', 'yes', 'no', 'no', 'yes', 'no', 'no', 'yes', 'no', 'no', 'yes', 'yes', 'yes', 'no', 'no', 'vip', 'no', 'no', '', '', 0, 'Disabled', 0, 0, '0.00', 0, 0, 0, 0, 'no', 'no', 0, 'no', 'no', 'no', 'no', 'no', 'no', 'yes', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 5, 'no', 'no', 'no', 'no', '0', NULL, 'no', 1),
(6, 6, 'Moderator', 'yes', 'yes', 'no', 'yes', 'no', 'no', 'yes', 'yes', 'no', 'yes', 'yes', 'yes', 'yes', 'no', 'moderator', 'no', 'no', '<span style=''color: #428D67''>', '</span>', 0, 'Disabled', 0, 0, '0.00', 0, 0, 0, 0, 'no', 'no', 0, 'no', 'no', 'no', 'no', 'no', 'no', 'yes', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 6, 'no', 'no', 'no', 'no', '0', NULL, 'no', 1),
(7, 7, 'Administrator', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'no', 'yes', 'yes', 'yes', 'yes', 'admin', 'no', 'yes', '<span style=''color:#FF8000''>', '</span>', 0, 'Disabled', 0, 0, '0.00', 0, 0, 0, 0, 'no', 'no', 0, 'no', 'no', 'no', 'no', 'no', 'no', 'yes', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 7, 'no', 'no', 'no', 'no', '0', NULL, 'no', 1),
(8, 8, 'Owner', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'owner', 'no', 'yes', '<span style=''color:#EE4000''>', '</span>', 0, 'Disabled', 0, 0, '0.00', 0, 0, 0, 0, 'no', 'no', 0, 'no', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 8, 'no', 'no', 'no', 'no', '0', NULL, 'no', 1);
